...
function displayChartForIndex(indexName) {
    ...
    const closingValues = filteredData.map(item => parseFloat(item.open_index_value)); // Closing values of the index
    ...
    window.stockChart = new Chart(ctx, {
        ...
        data: {
            labels: labels,
            datasets: [{
                label: `${indexName} Index opening Value`,  // Corrected template literal syntax
                data: closingValues,
